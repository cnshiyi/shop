...
channel.exec_command("bash -lc 'echo RUN_COMMAND; cat /home/mtproxy/run-command.sh || true; echo SEP; systemctl status mtproxy.service --no-pager -l || true; echo SEP; journalctl -u mtproxy.service -n 50 --no-pager || true'")
out = b''
err = b''
while True:
