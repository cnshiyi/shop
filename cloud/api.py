...
from cloud.dashboard_order_helpers import _cloud_asset_detail_log_queryset, _cloud_order_detail_payload, _cloud_order_source_label, _cloud_order_source_tags, _cloud_order_summary_payload, _mask_secret, _related_order_history_payload
...
def update_cloud_asset(request, asset_id):
    if request.method == 'GET':
        ...
        order = _infer_asset_order(asset)
        logs = list(_cloud_asset_detail_log_queryset(asset, order)[:100])
