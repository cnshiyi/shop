...
def _order_payload(order):
    ...
    return {
        ...
        'payer_address': getattr(order, 'payer_address', None),
        'receive_address': getattr(order, 'receive_address', None),
...
def _recharge_detail_payload(recharge):
    ...
    return {
        ...
        'payer_address': getattr(recharge, 'payer_address', None),
        'receive_address': getattr(recharge, 'receive_address', None),
        'tronscan_url': f'https://tronscan.org/#/transaction/{recharge.tx_hash}' if recharge.tx_hash else '',
