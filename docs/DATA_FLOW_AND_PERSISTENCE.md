...
后台前后端分离接口大多直接读 ORM：
- `dashboard_api/views.py:449` 站点配置列表
- `dashboard_api/views.py:485` 云账户配置列表
- `dashboard_api/views.py:673` 工作台聚合统计
- `dashboard_api/views.py:732` 用户列表
- `dashboard_api/views.py:949` 商品列表
- `dashboard_api/views.py:1080` 商品订单列表
- `dashboard_api/views.py:1094` 云服务器订单列表
- `dashboard_api/views.py:1262` 云资产列表
- `dashboard_api/views.py:1856` 服务器列表
- `dashboard_api/views.py:2072` 云套餐列表
- `dashboard_api/views.py:2263` 充值记录列表
- `dashboard_api/views.py:2276` 监控地址列表

结论：后台 API 的读取主链路已经以数据库为主，这部分方向是对的。
...
### 1. 后台 API 写数据库
`dashboard_api/views.py` 已有大量写入数据库的入口：

- 配置
  - `SiteConfig.objects.get_or_create(...)`：`dashboard_api/views.py:459`
  - 更新配置：`dashboard_api/views.py:478`
- 云账户配置
  - 创建：`dashboard_api/views.py:506`
  - 更新：`dashboard_api/views.py:545`
- 用户余额
  - 余额流水：`dashboard_api/views.py:61`
  - 余额修改：`dashboard_api/views.py:803`
- 用户折扣
  - `dashboard_api/views.py:846`
- 用户名归一化
  - `dashboard_api/views.py:1228`
  - `dashboard_api/views.py:1248`
- 商品
  - 创建：`dashboard_api/views.py:989`
  - 更新：`dashboard_api/views.py:1045`
- 云资产 / 服务器 / 订单状态
  - `dashboard_api/views.py:639`
  - `dashboard_api/views.py:648`
  - `dashboard_api/views.py:666`
  - `dashboard_api/views.py:1305`
  - `dashboard_api/views.py:1450`
  - `dashboard_api/views.py:1452`
  - `dashboard_api/views.py:1758`
  - `dashboard_api/views.py:1761`
  - `dashboard_api/views.py:1767`
  - `dashboard_api/views.py:1775`
  - `dashboard_api/views.py:1780`
- 云套餐
  - 创建：`dashboard_api/views.py:2172`
  - 更新：`dashboard_api/views.py:2252`
- 充值状态
  - `dashboard_api/views.py:1670`

结论：后台 API 已经是一个核心写入面。
...
- `cloud/lifecycle.py`
- `dashboard_api/views.py` 中调用第三方接口的位置
  统一补日志写入
