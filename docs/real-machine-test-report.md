...
- 资源清理必须记录订单 ID、资产 ID、实例名、固定 IP 名称、区域、执行时间和结果。
- 真实支付和链上广播不在本次测试范围内。
...
- 资产：`#323`
- 云实例：`20260602-990000000001-5-o77`
- 区域：`ap-southeast-1`
- 固定 IP 名称：`20260602-990000000001-5-o77-ip`
- 公网 IP：`13.215.210.144`
...
- 新资产：`#324`
- 新云实例：`20260602-990000000001-5-o78`
- 新固定 IP 名称：`20260602-990000000001-5-o78-ip`
- 新公网 IP：`13.251.206.93`
