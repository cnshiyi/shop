...
urlpatterns = [
    ...
    path('tasks/notices/refresh/', cloud_api.refresh_notice_plan_table, name='notice-task-refresh'),
    path('tasks/notices/switches/', cloud_api.update_notice_switches, name='notice-task-switches-update'),
    path('tasks/notices/history/<str:identifier>/delete/', cloud_api.delete_notice_history, name='notice-history-delete'),
    path('tasks/notices/text/', cloud_api.update_notice_plan_text, name='notice-task-text-update'),
    ...
    path('cloud-assets/risk-summary/', cloud_api.cloud_assets_risk_summary, name='cloud-assets-risk-summary'),
    ...
    path('cloud-assets/<int:asset_id>/sync/', cloud_api.sync_cloud_asset_status, name='cloud-asset-sync'),
