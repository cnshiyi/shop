...
urlpatterns = [
    ...
    path('auth/github/start', bot_api.auth_github_start, name='auth-github-start'),
    path('auth/github/callback', bot_api.auth_github_callback, name='auth-github-callback'),
